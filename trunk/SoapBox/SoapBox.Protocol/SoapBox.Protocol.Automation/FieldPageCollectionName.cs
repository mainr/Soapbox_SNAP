...
{
    public sealed class FieldPageCollectionName : FieldBase
    {
        public FieldPageCollectionName()
            : base(String.Empty)
        {
        }

        public FieldPageCollectionName(String PageCollectionName)
            : base(PageCollectionName)
        {
        }
