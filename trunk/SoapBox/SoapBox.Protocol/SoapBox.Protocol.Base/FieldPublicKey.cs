...
{
    /// <summary>
    /// Implements the concept of a public key.  Stored as a hex string.
    /// </summary>
    public sealed class FieldPublicKey : FieldBase
    {

        public FieldPublicKey(String Key) : base(Key)
        {
        }
        ...
        {
            //It has to be hex
            Match m = Regex.Match(Field, "^[0-9a-fA-F]*$");
            if (m.Success)
            {
