...
namespace SoapBox.Snap.LD
{
    ...
    [InstructionItem(
        ...
        Code = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.CntUP,
        SortOrder = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.CntUP_SortOrder,
        SpriteType = typeof(Resources.Images), SpriteKey = "SprCntUP",
        ToolTipType = typeof(Resources.Strings), ToolTipKey = "ToolTipCntUP")]
    public class InstructionLDCntUP : InstructionLDAbstractCounter
    {
        ...
        internal static readonly FieldInstructionType m_InstructionType = new FieldInstructionType(
                    ...
                    new FieldIdentifier(Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.CntUP));

        /// <summary>
        /// Just here for MEF to call, to do the imports
        /// </summary>
        internal InstructionLDCntUP()
            : base(m_InstructionType)
        {
        }

        private InstructionLDCntUP(IEditorItem parent, NodeInstruction instruction)
        ...
        public override string InstructionName
        {
            get 
            {
                return Resources.Strings.LD_Snap_CntUP_InstructionName;
            }
        }
        ...
        [ImportMany(ExtensionPoints.Instructions.CntUP.ContextMenu, typeof(IMenuItem))]
        ...
        {
            return new InstructionLDCntUP(parent, instruction);
        }
