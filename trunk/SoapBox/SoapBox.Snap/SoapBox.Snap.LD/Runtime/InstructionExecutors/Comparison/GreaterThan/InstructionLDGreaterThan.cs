...
namespace SoapBox.Snap.LD.Runtime.InstructionExecutors
{
    ...
    class InstructionLDGreaterThan : InstructionLDComparisonBase
    {
        public InstructionLDGreaterThan()
            : base(SoapBox.Snap.LD.InstructionLDGreaterThan.m_InstructionType)
        {
        }
