...
namespace SoapBox.Snap.LD.Runtime.InstructionExecutors
{
    ...
    class InstructionLDChooseNumber : InstructionLDMathBase
    {
        public InstructionLDChooseNumber()
            : base(SoapBox.Snap.LD.InstructionLDChooseNumber.m_InstructionType)
        {
        }

        protected override decimal ComputeResult(bool rungIn, decimal input1, decimal input2, decimal oldResult)
        {
            return rungIn ? input1 : input2; ;
        }
    }
}
