...
// Copied from here: http://blogs.msdn.com/astebner/archive/2006/08/12/696833.aspx
// Many, many, many thanks to Aaron Stebner for this.

// Configurable values
var checkboxChecked = true;			// Is the checkbox on the finished dialog checked by default?
var checkboxText = "Launch SoapBox Snap (this can take a minute before you see anything)";	// Text for the checkbox on the finished dialog
var filename = "SoapBox.Core.Host.exe"; 	// The name of the executable to launch - change this to match the file you want to launch at the end of your setup
