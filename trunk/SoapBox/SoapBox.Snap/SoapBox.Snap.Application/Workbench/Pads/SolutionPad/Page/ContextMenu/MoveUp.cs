...
namespace SoapBox.Snap.Application.Workbench.Pads.SolutionPad.PageItem.ContextMenu
{
    ...
    class MoveUp : AbstractMenuItem
    {
        public MoveUp()
        {
            ID = Extensions.Workbench.Pads.SolutionPad_.PageItem.ContextMenu.MoveUp;
            Header = Resources.Strings.Solution_Pad_PageItem_MoveUp;
            ToolTip = Resources.Strings.Solution_Pad_PageItem_MoveUp_ToolTip;
            SetIconFromBitmap(Resources.Images.Page_MoveUp);
        }
