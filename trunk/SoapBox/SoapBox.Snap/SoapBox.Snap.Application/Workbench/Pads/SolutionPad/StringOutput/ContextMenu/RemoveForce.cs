...
namespace SoapBox.Snap.Application.Workbench.Pads.SolutionPad.StringOutput.ContextMenu
{
    ...
    class RemoveForce : AbstractMenuItem
    {
        public RemoveForce()
        {
            ID = Extensions.Workbench.Pads.SolutionPad_.StringOutputItem.ContextMenu.RemoveForce;
            Header = Resources.Strings.Solution_Pad_StringOutputItem_RemoveForce;
            ToolTip = Resources.Strings.Solution_Pad_StringOutputItem_RemoveForce_ToolTip;

            InsertRelativeToID = Extensions.Workbench.Pads.SolutionPad_.StringOutputItem.ContextMenu.Force;
        ...
        protected override void Run()
        {
            ...
            if (di != null)
            {
                di.StringOutput = di.StringOutput.SetForced(new FieldBool(false));
            }
        }
    }
}
