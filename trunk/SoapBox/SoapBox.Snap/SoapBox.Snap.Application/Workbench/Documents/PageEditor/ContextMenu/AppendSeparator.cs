...
namespace SoapBox.Snap.Application.Workbench.Documents.PageEditor.ContextMenu
{
    ...
    class AppendSeparator : ConcreteMenuItemSeparator
    {
        public AppendSeparator()
        {
            ID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.AppendSeparator;
            BeforeOrAfter = RelativeDirection.After;
            InsertRelativeToID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.InsertAfter;
