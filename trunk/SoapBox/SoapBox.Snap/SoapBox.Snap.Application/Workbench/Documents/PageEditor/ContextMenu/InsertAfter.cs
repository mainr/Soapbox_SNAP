...
namespace SoapBox.Snap.Application.Workbench.Documents.PageEditor.ContextMenu
{
    ...
    class InsertAfter : AbstractMenuItem, IPartImportsSatisfiedNotification
    {
        public InsertAfter()
        {
            ID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.InsertAfter;
            Header = Resources.Strings.PageEditor_GroupCommand_InsertAfter;
            BeforeOrAfter = RelativeDirection.After;
            InsertRelativeToID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.InsertBefore;
        }
        ...
        public void OnImportsSatisfied()
        {
            ...
            {
                newItems.Add(new InsertAfterWrapper(groupItem));
            }
            Items = newItems;
        }
    }

    class InsertAfterWrapper : AbstractMenuItem
    {
        public InsertAfterWrapper(Lazy<IInstructionGroupItem, IInstructionGroupItemMeta> groupItem)
        {
            if (groupItem == null)
            {
        ...
        protected override void Run()
        {
            ...
            {
                pageEditorItem.InsertAfterInstructionGroup(m_groupItem.Value);
            }
        }
    }
}
