...
namespace SoapBox.Snap.Application.Workbench.Documents.PageEditor.ContextMenu
{
    ...
    class MoveSeparator : ConcreteMenuItemSeparator
    {
        public MoveSeparator()
        {
            ID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.MoveSeparator;
            BeforeOrAfter = RelativeDirection.After;
            InsertRelativeToID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.MoveDown;
