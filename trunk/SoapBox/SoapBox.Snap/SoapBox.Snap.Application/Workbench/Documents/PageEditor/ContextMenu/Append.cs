...
namespace SoapBox.Snap.Application.Workbench.Documents.PageEditor.ContextMenu
{
    ...
    class Append : AbstractMenuItem, IPartImportsSatisfiedNotification
    {
        public Append()
        {
            ID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.Append;
            Header = Resources.Strings.PageEditor_GroupCommand_Append;
        }
        ...
        public void OnImportsSatisfied()
        {
            ...
            {
                newItems.Add(new AppendWrapper(groupItem));
            }
            Items = newItems;
        }
    }

    class AppendWrapper : AbstractMenuItem
    {
        public AppendWrapper(Lazy<IInstructionGroupItem, IInstructionGroupItemMeta> groupItem)
        {
            if (groupItem == null)
            {
        ...
        protected override void Run()
        {
            ...
            {
                pageEditorItem.AppendInstructionGroup(m_groupItem.Value);
            }
        }
    }
}
