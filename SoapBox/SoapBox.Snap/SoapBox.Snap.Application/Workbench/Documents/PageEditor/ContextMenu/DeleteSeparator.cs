...
namespace SoapBox.Snap.Application.Workbench.Documents.PageEditor.ContextMenu
{
    ...
    class DeleteSeparator : ConcreteMenuItemSeparator
    {
        public DeleteSeparator()
        {
            ID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.DeleteSeparator;
            BeforeOrAfter = RelativeDirection.After;
            InsertRelativeToID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.Redo;
        }
    }
}
