...
namespace SoapBox.Snap.Application.Workbench.Documents.PageEditor.ContextMenu
{
    ...
    class MoveDown : AbstractMenuItem
    {
        public MoveDown()
        {
            ID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.MoveDown;
            Header = Resources.Strings.PageEditor_GroupCommand_MoveDown;
            ToolTip = Resources.Strings.PageEditor_GroupCommand_MoveDown_ToolTip;
            SetIconFromBitmap(Resources.Images.PageEditor_MoveDown);
            BeforeOrAfter = RelativeDirection.After;
            InsertRelativeToID = Extensions.Workbench.Documents.PageEditor_.ContextMenu.MoveUp;
        ...
        protected override void Run()
        {
            ...
            {
                pageEditorItem.MoveSelectedDown();
            }
        }
    }
}
