...
namespace SoapBox.Snap.Application.Workbench.Pads.SolutionPad.RuntimeApplication.ContextMenu
{
    ...
    class Connect : AbstractMenuItem
    {
        public Connect()
        {
            ID = Extensions.Workbench.Pads.SolutionPad_.RuntimeApplicationItem.ContextMenu.Connect;
            Header = Resources.Strings.Solution_Pad_RuntimeApplicationItem_Connect;
            ToolTip = Resources.Strings.Solution_Pad_RuntimeApplicationItem_Connect_ToolTip;
