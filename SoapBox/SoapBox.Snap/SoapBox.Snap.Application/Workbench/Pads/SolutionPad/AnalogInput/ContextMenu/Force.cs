...
namespace SoapBox.Snap.Application.Workbench.Pads.SolutionPad.AnalogInput.ContextMenu
{
    ...
    class Force : AbstractMenuItem
    {
        public Force()
        {
            ID = Extensions.Workbench.Pads.SolutionPad_.AnalogInputItem.ContextMenu.Force;
            Header = Resources.Strings.Solution_Pad_AnalogInputItem_Force;
            ToolTip = Resources.Strings.Solution_Pad_AnalogInputItem_Force_ToolTip;
        ...
        protected override void Run()
        {
            ...
            if (di != null)
            {
                var nAnalogInput = di.AnalogInput.SetForced(new FieldBool(true));
                nAnalogInput = nAnalogInput.SetForcedValue(runtimeService.GetConstant(FieldDataType.DataTypeEnum.NUMBER, di.AnalogInput.ForcedValue)); 
                di.AnalogInput = nAnalogInput;
            }
        }
    }
}
