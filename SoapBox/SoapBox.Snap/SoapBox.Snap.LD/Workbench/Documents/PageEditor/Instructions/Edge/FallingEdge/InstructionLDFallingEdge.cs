...
namespace SoapBox.Snap.LD
{
    ...
    [InstructionItem(
        ...
        Code = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.FallingEdge,
        SortOrder = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.FallingEdge_SortOrder,
        SpriteType = typeof(Resources.Images), SpriteKey = "SprFallingEdge",
        ToolTipType = typeof(Resources.Strings), ToolTipKey = "ToolTipFallingEdge")]
    public class InstructionLDFallingEdge : InstructionLDAbstractEdge
    {
        ...
        internal static readonly FieldInstructionType m_InstructionType = new FieldInstructionType(
                    ...
                    new FieldIdentifier(Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.FallingEdge));

        /// <summary>
        /// Just here for MEF to call, to do the imports
        /// </summary>
        internal InstructionLDFallingEdge()
        ...
        public override string InstructionName
        {
            get 
            {
                return Resources.Strings.LD_Snap_FallingEdge_InstructionName;
            }
        }
        ...
        [ImportMany(ExtensionPoints.Instructions.FallingEdge.ContextMenu, typeof(IMenuItem))]
        ...
        {
            return new InstructionLDFallingEdge(parent, instruction);
        }
