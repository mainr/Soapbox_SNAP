...
namespace SoapBox.Snap.LD
{
    ...
    [InstructionItem(
        ...
        Code = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.TmrON,
        SortOrder = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.TmrON_SortOrder,
        SpriteType = typeof(Resources.Images), SpriteKey = "SprTmrON",
        ToolTipType = typeof(Resources.Strings), ToolTipKey = "ToolTipTmrON")]
    public class InstructionLDTmrON : InstructionLDAbstractTimer
    {
        ...
        internal static readonly FieldInstructionType m_InstructionType = new FieldInstructionType(
                    ...
                    new FieldIdentifier(Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.TmrON));

        /// <summary>
        /// Just here for MEF to call, to do the imports
        /// </summary>
        internal InstructionLDTmrON()
        ...
        public override string InstructionName
        {
            get 
            {
                return Resources.Strings.LD_Snap_TmrON_InstructionName;
            }
        }
        ...
        [ImportMany(ExtensionPoints.Instructions.TmrON.ContextMenu, typeof(IMenuItem))]
