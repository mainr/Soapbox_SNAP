...
namespace SoapBox.Snap.LD
{
    ...
    [InstructionItem(
        ...
        Code = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.TmrOFF,
        SortOrder = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.TmrOFF_SortOrder,
        SpriteType = typeof(Resources.Images), SpriteKey = "SprTmrOFF",
        ToolTipType = typeof(Resources.Strings), ToolTipKey = "ToolTipTmrOFF")]
    public class InstructionLDTmrOFF : InstructionLDAbstractTimer
    {
        ...
        internal static readonly FieldInstructionType m_InstructionType = new FieldInstructionType(
                    ...
                    new FieldIdentifier(Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.Snap_.TmrOFF));
        ...
        private InstructionLDTmrOFF(IEditorItem parent, NodeInstruction instruction)
        ...
        public override string InstructionName
        {
            get 
            {
                return Resources.Strings.LD_Snap_TmrOFF_InstructionName;
            }
        }
        ...
        [ImportMany(ExtensionPoints.Instructions.TmrOFF.ContextMenu, typeof(IMenuItem))]
        ...
        {
            return new InstructionLDTmrOFF(parent, instruction);
        }
