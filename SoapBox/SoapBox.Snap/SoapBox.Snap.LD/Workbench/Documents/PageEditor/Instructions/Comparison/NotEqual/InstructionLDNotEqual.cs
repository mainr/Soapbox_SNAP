...
namespace SoapBox.Snap.LD
{
    ...
    [InstructionItem(
        ...
        Code = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.SnapComparison_.NotEqual,
        SortOrder = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.SnapComparison_.NotEqual_SortOrder,
        SpriteType = typeof(Resources.Images), SpriteKey = "SprNotEqual",
        ToolTipType = typeof(Resources.Strings), ToolTipKey = "ToolTipNotEqual")]
    public class InstructionLDNotEqual : InstructionLDComparisonBase
    {
        internal static readonly FieldInstructionType m_InstructionType = new FieldInstructionType(
                   ...
                   new FieldIdentifier(Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.SnapComparison_.NotEqual));

        internal InstructionLDNotEqual()
            : base(null, m_InstructionType, null, true,
            Resources.Strings.LD_Snap_NotEqual_InstructionName,
            Resources.Strings.LD_Snap_NotEqual_FirstSignalName, Resources.Strings.LD_Snap_NotEqual_SecondSignalName)
        {
        }

        protected InstructionLDNotEqual(IEditorItem parent, NodeInstruction instruction)
        ...
        [ImportMany(ExtensionPoints.Instructions.NotEqual.ContextMenu, typeof(IMenuItem))]
        ...
        {
            return new InstructionLDNotEqual(parent, instruction);
        }
