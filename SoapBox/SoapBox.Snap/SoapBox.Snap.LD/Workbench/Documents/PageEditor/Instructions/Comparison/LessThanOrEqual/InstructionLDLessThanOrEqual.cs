...
namespace SoapBox.Snap.LD
{
    ...
    [InstructionItem(
        ...
        Code = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.SnapComparison_.LessThanOrEqual,
        SortOrder = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.SnapComparison_.LessThanOrEqual_SortOrder,
        SpriteType = typeof(Resources.Images), SpriteKey = "SprLessThanOrEqual",
        ToolTipType = typeof(Resources.Strings), ToolTipKey = "ToolTipLessThanOrEqual")]
    public class InstructionLDLessThanOrEqual : InstructionLDComparisonBase
    {
        internal static readonly FieldInstructionType m_InstructionType = new FieldInstructionType(
                   ...
                   new FieldIdentifier(Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.SnapComparison_.LessThanOrEqual));

        internal InstructionLDLessThanOrEqual()
            : base(null, m_InstructionType, null, true,
            Resources.Strings.LD_Snap_LessThanOrEqual_InstructionName,
            Resources.Strings.LD_Snap_LessThanOrEqual_FirstSignalName, Resources.Strings.LD_Snap_LessThanOrEqual_SecondSignalName)
        {
        }

        protected InstructionLDLessThanOrEqual(IEditorItem parent, NodeInstruction instruction)
        ...
        [ImportMany(ExtensionPoints.Instructions.LessThanOrEqual.ContextMenu, typeof(IMenuItem))]
        ...
        {
            return new InstructionLDLessThanOrEqual(parent, instruction);
        }
