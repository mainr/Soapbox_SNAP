...
namespace SoapBox.Snap.LD
{
    ...
    [InstructionItem(
        ...
        Code = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.SnapComparison_.LessThan,
        SortOrder = Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.SnapComparison_.LessThan_SortOrder,
        SpriteType = typeof(Resources.Images), SpriteKey = "SprLessThan",
        ToolTipType = typeof(Resources.Strings), ToolTipKey = "ToolTipLessThan")]
    public class InstructionLDLessThan : InstructionLDComparisonBase
    {
        internal static readonly FieldInstructionType m_InstructionType = new FieldInstructionType(
                   ...
                   new FieldIdentifier(Extensions.Workbench.Documents.PageEditor_.InstructionItems.LD_.SnapComparison_.LessThan));

        internal InstructionLDLessThan()
        ...
        [ImportMany(ExtensionPoints.Instructions.LessThan.ContextMenu, typeof(IMenuItem))]
