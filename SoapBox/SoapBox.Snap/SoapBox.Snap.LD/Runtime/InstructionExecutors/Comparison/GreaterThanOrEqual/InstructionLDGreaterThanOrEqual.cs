...
namespace SoapBox.Snap.LD.Runtime.InstructionExecutors
{
    ...
    class InstructionLDGreaterThanOrEqual : InstructionLDComparisonBase
    {
        public InstructionLDGreaterThanOrEqual()
            : base(SoapBox.Snap.LD.InstructionLDGreaterThanOrEqual.m_InstructionType)
        {
        }
