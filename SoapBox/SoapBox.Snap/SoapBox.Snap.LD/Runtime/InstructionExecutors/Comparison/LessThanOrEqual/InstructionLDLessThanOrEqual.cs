...
namespace SoapBox.Snap.LD.Runtime.InstructionExecutors
{
    ...
    class InstructionLDLessThanOrEqual : InstructionLDComparisonBase
    {
        public InstructionLDLessThanOrEqual()
            : base(SoapBox.Snap.LD.InstructionLDLessThanOrEqual.m_InstructionType)
        {
        }
