...
namespace SoapBox.Snap.LD.Runtime.InstructionExecutors
{
    ...
    class InstructionLDCntUP: AbstractExtension, IInstructionExecutor<InstructionGroupExecutorContextLD>
    {
        ...
        public FieldInstructionType InstructionType
        {
            get 
            { 
                return SoapBox.Snap.LD.InstructionLDCntUP.m_InstructionType; 
            }
        }
