...
namespace SoapBox.Snap.LD.Runtime.InstructionExecutors
{
    ...
    class InstructionLDTmrON: AbstractExtension, IInstructionExecutor<InstructionGroupExecutorContextLD>
    {
        ...
        public FieldInstructionType InstructionType
        {
            get 
            { 
                return SoapBox.Snap.LD.InstructionLDTmrON.m_InstructionType; 
            }
        }
            ...
            InstructionGroupExecutorContextLD context)
        {
            ...
            else
            {
                ...
                newRungOutCondition = (newElapsed >= setPoint);
