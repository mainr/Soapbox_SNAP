...
namespace SoapBox.Snap.LD.Runtime.InstructionExecutors
{
    ...
    class InstructionLDFallingEdge: AbstractExtension, IInstructionExecutor<InstructionGroupExecutorContextLD>
    {
        public FieldInstructionType InstructionType
        {
            get 
            { 
                return SoapBox.Snap.LD.InstructionLDFallingEdge.m_InstructionType; 
            }
        }
