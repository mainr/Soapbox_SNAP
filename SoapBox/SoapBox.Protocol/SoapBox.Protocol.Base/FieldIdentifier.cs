...
{
    /// <summary>
    /// Implements the concept of an Identifier.  A human readable string field
    /// in the format of a letter followed by any number of letters, numbers and underscores.
    /// </summary>
    public sealed class FieldIdentifier : FieldBase
    {

        public FieldIdentifier(String Identifier) : base(Identifier)
        {
        }
        ...
        {
            //It has to start with an upper or lower case character
            //and can then contain characters or numerals, and underscores
            Match m = Regex.Match(Field, "^[a-zA-Z][_a-zA-Z0-9]*$");
            if (m.Success)
            {
